...
<!-- ========================================================================================================================================= -->
<!-- DEBUT AFFICHAGE DE CONTENU FORMATION -->
<!-- ========================================================================================================================================= -->

<?php
  include("connexion.php");
  $req = "SELECT * FROM formation where id = $user_id";
  // $req = "SELECT * FROM formation where id ='4' ";
...
<div class="all-affichage" >
    <div class="info"  >
        <p class="titre-page" > <strong><?php echo $row['hpa']; ?> </strong> </p>
                    ...
                    <div class="accordion-item">
                      ...
                      <div class="accordion-item">
                          <h2 class="accordion-header" id="headingTwo">
                              <button type="button" class="accordion-button collapsed fw-bold" data-bs-toggle="collapse" data-bs-target="#collapseTwo">2. Modules</button>									
                          </h2>
                      ...
                      <div class="accordion-item">
                          <h2 class="accordion-header" id="headingThree">
                              <button type="button" class="accordion-button collapsed fw-bold" data-bs-toggle="collapse" data-bs-target="#collapseThree">3. Cibles</button>
                          </h2>
                          <div id="collapseThree" class="accordion-collapse collapse " data-bs-parent="#myAccordion">
                              <div class="card-body montexterecuperer">
                                <?php 
                                       $textCible = $row['cible']; 
                                       $textCible = nl2br($textCible);
                                       echo $textCible;
                                 ?>                               
                              </div>
                          </div>
                      ...
                      <div class="accordion-item">
                          <h2 class="accordion-header" id="headingFour">
                              <button type="button" class="accordion-button collapsed fw-bold" data-bs-toggle="collapse" data-bs-target="#collapseFour">4. Prérequis</button>                     
                          </h2>
                          <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                              <div class="card-body">
                                  <p>
                                       <?php 
                                       $textPrerequis = $row['prerequis']; 
                                       $textPrerequis = nl2br($textPrerequis);
                                       echo $textPrerequis;
                                         ?>
                                  </p>
                              </div>
        ...
        <div class="mt-4">
          <div class="d-flex">
              ...
              <div class="flex-grow-1 ms-3 ">
                <a href="certificat.php?id=<?php echo $row['id']; ?>"><?php echo $row['libelle']; ?></a>
              </div>
          </div>
        </div>
...
<!-- Ajout de enctype="multipart/form-data" pour la soumission des fichiers -->
...
<!-- ========================================================================================================================================= -->
            ...
            <!-- quatrieme ligne -->
            <div class="col mb-3">
              <label for="formation" >Nos certificats <span style="color:red; " >*</span></label>
            <input 
            type="text" 
            readonly class="form-control" 
            name="certificat" 
            id="formation" 
            value="<?php echo $row['hpa']; ?> (<?php echo $row['libelle']; ?>)" required>
           </div> <br>
...
<div style="width: 100%; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
    ...
    <!-- Bouton Soumission standard (base de données / e-mail / pièces jointes) -->
    <button type="submit" class="btn s" name="submit">Soumettre via le site</button>

    <!-- Bouton WhatsApp Lead Gen (envoi des infos direct au commercial) -->
    <button type="button" class="btn btn-success d-flex align-items-center" style="border-radius: 5px; padding: 10px 20px; font-weight: bold;" onclick="sendToWhatsapp()">
  ...
  <!-- Footer -->
    ...
    function sendToWhatsapp() {
        ...
        if (!nom || !prenom || !contact || !formation || !mail) {
            alert("Veuillez remplir au moins les champs obligatoires (Nom, Prénom, Contact, Mail) avant d'envoyer par WhatsApp.");
            return;
        }
        ...
        textMessage += "📘 *Formation visée :* " + formation + "\n";
