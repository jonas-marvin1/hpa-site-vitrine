      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <fieldset>Preinscrit</fieldset></li>
          </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <!-- <a class="btn btn-outline-danger btn-sm mb-0 me-3" target="_blank" href="#">Ajouter une formation</a> -->
            </li>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">CreatedOn</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Résidence</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Niveau d'Etude</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fonction</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">HPA</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Certificat</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Commentaire</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Diplôme</th>
                ...
                <?php
                  ...
                  $req = "SELECT * FROM preinscription ";
                ...
                ?>
                    ...
                    <tr >
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0 "><?php echo $row['createdon']; ?></p>
                      </td> 
                    
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['nom']; ?></p>
                      </td>     
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['prenom']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['mail']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['sexe']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['residence']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['niveau_etude']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['fonction']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold"><?php echo $row['hpa_connaitre']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['formation_choisir']; ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['commentaire']; ?></span>
                      </td>
                       ...
                       <td class="align-middle text-center">
                        <div >
                          <div>
                            <?php
                              // rawurlencode : les anciens fichiers ont des noms avec espaces
                            ...
                            <a href="<?php echo $lien_diplome !== '' ? htmlspecialchars($lien_diplome, ENT_QUOTES) : 'javascript:void(0)'; ?>"
                               <?php echo $lien_diplome !== ''
                                   ? 'target="_blank" rel="noopener" title="Ouvrir le diplôme"'
                                   : 'title="Aucun diplôme fourni" style="opacity:.25;cursor:default"'; ?>>
                                <!--logo vew-->
                            
                            <svg width="20px" height="20px" viewBox="0 0 24 24" id="SVGRoot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:svg="http://www.w3.org/2000/svg" fill="#ff0000" stroke="#e30613"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.096"></g><g id="SVGRepo_iconCarrier"> <defs id="defs2"></defs> <g id="layer1"> <path d="M 12 4 C 8.6666667 4 5.7335794 5.6316279 3.6191406 7.3496094 C 2.5619212 8.2086001 1.7059096 9.0941755 1.09375 9.859375 C 0.78767021 10.241975 0.54228306 10.592509 0.35742188 10.916016 C 0.17256067 11.239523 3.7007434e-17 11.458333 0 12 C 0 12.541667 0.17256067 12.760477 0.35742188 13.083984 C 0.54228307 13.407491 0.78767021 13.758025 1.09375 14.140625 C 1.7059096 14.905824 2.5619212 15.7914 3.6191406 16.650391 C 5.7335794 18.368372 8.6666667 20 12 20 C 15.333333 20 18.266421 18.368372 20.380859 16.650391 C 21.438079 15.7914 22.29409 14.905824 22.90625 14.140625 C 23.21233 13.758025 23.457717 13.407491 23.642578 13.083984 C 23.827439 12.760477 24 12.541667 24 12 C 24 11.458333 23.827439 11.239523 23.642578 10.916016 C 23.457717 10.592509 23.21233 10.241975 22.90625 9.859375 C 22.29409 9.0941755 21.438079 8.2086001 20.380859 7.3496094 C 18.266421 5.6316279 15.333333 4 12 4 z M 12 6 C 14.666667 6 17.233579 7.3683721 19.119141 8.9003906 C 20.061921 9.6663999 20.83091 10.468324 21.34375 11.109375 C 21.60017 11.4299 21.792283 11.712179 21.904297 11.908203 C 21.926717 11.947439 21.926155 11.965225 21.939453 12 C 21.926155 12.034775 21.926717 12.052561 21.904297 12.091797 C 21.792283 12.287821 21.60017 12.5701 21.34375 12.890625 C 20.83091 13.531676 20.061921 14.3336 19.119141 15.099609 C 17.233579 16.631628 14.666667 18 12 18 C 9.3333333 18 6.7664206 16.631628 4.8808594 15.099609 C 3.9380788 14.3336 3.1690904 13.531676 2.65625 12.890625 C 2.3998298 12.5701 2.2077169 12.287821 2.0957031 12.091797 C 2.0732826 12.052561 2.073845 12.034775 2.0605469 12 C 2.073845 11.965225 2.0732826 11.947439 2.0957031 11.908203 C 2.2077169 11.712179 2.3998298 11.4299 2.65625 11.109375 C 3.1690904 10.468324 3.9380788 9.6663999 4.8808594 8.9003906 C 6.7664206 7.3683721 9.3333333 6 12 6 z M 11.939453 8 A 4 4 0 0 0 8 12 A 4 4 0 0 0 12 16 A 4 4 0 0 0 16 12 A 4 4 0 0 0 15.822266 10.824219 A 2 2 0 0 1 14 12 A 2 2 0 0 1 12 10 A 2 2 0 0 1 13.177734 8.1777344 A 4 4 0 0 0 12 8 A 4 4 0 0 0 11.939453 8 z " id="path6180" style="color:#00ff2a;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;font-size:medium;line-height:normal;font-family:sans-serif;font-variant-ligatures:normal;font-variant-position:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-alternates:normal;font-variant-east-asian:normal;font-feature-settings:normal;font-variation-settings:normal;text-indent:0;text-align:start;text-decoration:none;text-decoration-line:none;text-decoration-style:solid;text-decoration-color:#00ff2a;letter-spacing:normal;word-spacing:normal;text-transform:none;writing-mode:lr-tb;direction:ltr;text-orientation:mixed;dominant-baseline:auto;baseline-shift:baseline;text-anchor:start;white-space:normal;shape-padding:0;shape-margin:0;inline-size:0;clip-rule:nonzero;display:inline;overflow:visible;visibility:visible;isolation:auto;mix-blend-mode:normal;color-interpolation:sRGB;color-interpolation-filters:linearRGB;solid-color:#00ff2a;solid-opacity:1;vector-effect:none;fill:#00ff2a;fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1;color-rendering:auto;image-rendering:auto;shape-rendering:auto;text-rendering:auto;enable-background:accumulate;stop-color:#00ff2a;stop-opacity:1;opacity:1"></path> </g> </g></svg>
                                <!--logo vew-->
                            </a>
                          </div>
                        </div>
                        ...
                        <div >
                          <div>
                            ...
                            <a href="<?php echo $lien_cv !== '' ? htmlspecialchars($lien_cv, ENT_QUOTES) : 'javascript:void(0)'; ?>"
                               <?php echo $lien_cv !== ''
                                   ? 'target="_blank" rel="noopener" title="Ouvrir le CV"'
                                   : 'title="Aucun CV fourni" style="opacity:.25;cursor:default"'; ?>>
                      ...
                      <td class="align-middle text-center">
                        <button class="btn btn-sm btn-outline-danger" onclick="downloadRowPDF(this)">Télécharger PDF</button>
                      </td>
                    </tr>
...
function downloadRowPDF(btn) {
    ...
    // Title
    doc.setFontSize(18);
    doc.setTextColor(3, 33, 82);
    doc.text("Fiche de Préinscription HPA", 105, 20, { align: "center" });
    
    // Date
    doc.setFontSize(12);
    doc.setTextColor(0, 0, 0);
    doc.text("Date : " + cells[0].innerText.trim(), 105, 30, { align: "center" });
    
    // Line separator
    doc.setDrawColor(234, 6, 6);
    doc.setLineWidth(1);
    ...
    const bodyData = [
        ...
        ['Prénom', cells[2].innerText.trim()],
        ['Email', cells[3].innerText.trim()],
        ['Sexe', cells[4].innerText.trim()],
        ['Résidence', cells[5].innerText.trim()],
        ['Nationalité', cells[6].innerText.trim()],
        ['Contact', cells[7].innerText.trim()],
        ['Niveau d\'étude', cells[8].innerText.trim()],
        ['Fonction', cells[9].innerText.trim()],
        ['Comment a-t-il connu HPA ?', cells[10].innerText.trim()],
        ['Formation choisie', cells[11].innerText.trim()],
        ['Commentaire', cells[12].innerText.trim()]
    ];
    ...
    let filename = 'preinscription_' + cells[1].innerText.trim() + '_' + cells[2].innerText.trim() + '.pdf';
    doc.save(filename);
}
</script>
