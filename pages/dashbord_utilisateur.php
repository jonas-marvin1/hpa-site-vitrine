      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <fieldset>Utilisateurs</fieldset></li>
          </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-danger btn-sm mb-0 me-3" href="creer_utilisateur.php">Ajouter un Utilisateur</a>
            </li>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                          ...
                          $req = "SELECT * FROM `user` WHERE id != 1";
                          // $req = "SELECT * FROM user limit 1"; 
                          // pour afficher un certains nombree
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"> <?php echo $row['user']; ?><span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"> <?php echo $row['mdp']; ?></span>
                      </td>
                      
                      <td class="align-middle text-center">
                        <a href="modif_utilisateur.php?id=<?php echo $row['id']; ?>" title="Modifier"> 
                          <!--debut logo edit-->
                      ...
                      <td class="align-middle text-center">
                        <a href="delete_utilisateur.php?id=<?php echo $row['id']; ?>" title="Supprimer">
