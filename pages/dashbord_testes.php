        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-danger btn-sm mb-0 me-3" href="enregistrer_un_teste.php">Ajouter un teste</a>
            </li>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              <h6>
                  <a href="dashbord_formation.php" >Nos Certificats</a>&nbsp;/&nbsp;
                  <a href="dashbord_cours_intensifs.php" >Nos Cours Intensifs</a>&nbsp;/&nbsp;
                  <a href="dashbord_testes.php" style="font-weight: bold; color:black; text-transform: uppercase; text-decoration:underline;">Nos testes Internatinaux</a>
              </h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Deroulement</th>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td  class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['hpa_name']; ?></p>
                      </td>
                      ...
                      <td class="align-middle text-center ">
                       ...
                       <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Deroulement...</span>
                      </td>
                       <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Format...</span>
                      </td>
                       <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Score...</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['prerequis']; ?></span>
                      </td>
                       <td class="align-middle text-center">
                       ...
                       <td class="align-middle text-center">
                        <a href="modif_testes.php?id=<?php echo $row['id']; ?>" title="Modifier"> 
                          <!--debut logo edit-->
                      ...
                      <td class="align-middle text-center">
                        <a href="delete_testes.php?id=<?php echo $row['id']; ?>" title="Supprimer">
