...
if(isset($_POST["submit"])){
    ...
    if (!in_array($file_extension, $allowed_extensions)) {
        echo "<script>alert('Erreur : Seules les images JPG, JPEG et PNG sont autorisées.');</script>";
    } else {
        $new_file_name = uniqid('gal_') . '.' . $file_extension;
        $repertoire_image = "images/" . $new_file_name;

        if(move_uploaded_file($tmp, $repertoire_image)){
            $req = "INSERT INTO gallerie VALUES (NULL, ?, ?, CURRENT_TIMESTAMP)";
 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto mb-3 " id="sidenav-collapse-main" style="height: calc(100vh - 200px) !important;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="dashbord_gallerie.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg fill="#ffffff" width="256px" height="256px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>image-gallery-solid</title> <path d="M30.14,3h0a1,1,0,0,0-1-1h-22a1,1,0,0,0-1,1h0V4h24Z" class="clr-i-solid clr-i-solid-path-1"></path><path d="M32.12,7V7a1,1,0,0,0-1-1h-26a1,1,0,0,0-1,1h0V8h28Z" class="clr-i-solid clr-i-solid-path-2"></path><path d="M32.12,10H3.88A1.88,1.88,0,0,0,2,11.88V30.12A1.88,1.88,0,0,0,3.88,32H32.12A1.88,1.88,0,0,0,34,30.12V11.88A1.88,1.88,0,0,0,32.12,10ZM8.56,13.45a3,3,0,1,1-3,3A3,3,0,0,1,8.56,13.45ZM30,28h-24l7.46-7.47a.71.71,0,0,1,1,0l3.68,3.68L23.21,19a.71.71,0,0,1,1,0L30,24.79Z" class="clr-i-solid clr-i-solid-path-3"></path> <rect x="0" y="0" width="36" height="36" fill-opacity="0"></rect> </g></svg>
          </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <fieldset>Gallerie</fieldset></li>
          </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              ...
              <label style="margin-bottom: 10px;" >Ajouter une image...</label> <br>
              <input type="file" name="image" class="form-control"> <br>
              <input type="submit" name="submit" value="Ajouter une image" class="btn btn-outline-danger btn-sm mb-0 me-3">
              </form>
              <!-- <a class="btn btn-outline-danger btn-sm mb-0 me-3" target="_blank" href="#">Ajouter une image</a> -->
            </li>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center" >
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row['nom_image']; ?></p>
                      </td>
                      
                      <td >
                        <div class="d-flex px-2 py-1 justify-content-center">
                          <div>
                            <img src="<?php echo $row['repertoire_image']; ?>" class="avatar avatar-xxl" alt="user1">
                          </div>
                        </div>
                        
                      </td>
                      <td class="align-middle text-center" >
                        <a href="delete_gallerie.php?id=<?php echo $row['id']; ?>">
