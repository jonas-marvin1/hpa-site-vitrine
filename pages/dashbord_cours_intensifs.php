        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-danger btn-sm mb-0 me-3" href="enregistrer_cours_intensifs.php">Ajouter un cours</a>
            </li>
          ...
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              <h6>
                  ...
                  <a href="dashbord_cours_intensifs.php" style="font-weight: bold; color:black; text-transform: uppercase; text-decoration:underline;">Nos Cours Intensifs</a>&nbsp;/&nbsp;
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                       ...
                       <td class="align-middle text-center">
                        <a href="modif_cours_intensifs.php?id=<?php echo $row['id']; ?>" title="Modifier"> 
                          <!--debut logo edit-->
                      ...
                      <td class="align-middle text-center">
                        <a href="delete_cours_intensifs.php?id=<?php echo $row['id']; ?>" title="Supprimer">
