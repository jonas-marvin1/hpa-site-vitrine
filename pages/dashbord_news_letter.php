      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <fieldset>News_letter</fieldset></li>
          </ol>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-secondary text-xxs font-weight-bolder opacity-7">E-mail</th>
                  ...
                  <?php
                          ...
                          $req = "SELECT * FROM mail ";
                          // $req = "SELECT * FROM user limit 2"; pour afficher un certains nombre
                  ...
                  ?>
                    ...
                    <tr> 
                       <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $row['createdon']; ?></span>
                      </td>
