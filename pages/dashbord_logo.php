...
if(isset($_POST["submit"])){
    ...
    if (!in_array($file_extension, $allowed_extensions)) {
        ...
        $repertoire_image = "logos/" . $new_file_name;

        if(move_uploaded_file($tmp, $repertoire_image)){
            $req = "INSERT INTO logo VALUES (NULL, ?, ?, CURRENT_TIMESTAMP)";
 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto mb-3 " id="sidenav-collapse-main" style="height: calc(100vh - 200px) !important;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="dashbord_logo.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
           <svg width="256px" height="256px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs><style>.cls-1{fill:none;stroke:#ffffff;stroke-miterlimit:10;stroke-width:1.91px;}</style></defs><circle class="cls-1" cx="12" cy="4.34" r="2.86"></circle><circle class="cls-1" cx="19.64" cy="16.75" r="2.86"></circle><circle class="cls-1" cx="4.36" cy="16.75" r="2.86"></circle><path class="cls-1" d="M6,19.09a8.59,8.59,0,0,0,12,0"></path><path class="cls-1" d="M14.82,4.82a8.57,8.57,0,0,1,5.77,8.11,6.71,6.71,0,0,1-.08,1.1"></path><path class="cls-1" d="M3.49,14a6.71,6.71,0,0,1-.08-1.1A8.57,8.57,0,0,1,9.18,4.82"></path></g></svg>
          </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <fieldset>logo</fieldset></li>
          </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              ...
              <label style="margin-bottom: 10px;" >Ajouter un logo</label> <br>
              <input type="file" name="image" class="form-control"> <br>
              <input type="submit" name="submit" value="Ajouter un logo" class="btn btn-outline-danger btn-sm mb-0 me-3">
              </form>
            </li>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a  href="delete_logo.php?id=<?php echo $row['id']; ?>" target="_parent" class="button success">
