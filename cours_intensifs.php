...
<head>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <title>High Performance Academy - Cours Intensifs</title>
</head>
<body>
...
<!-- ========================================================================================================================================= -->
 ...
 <nav class="navbar navbar-expand-xl navbar-light bg-white sticky-top">
        ...
        <!-----------a propos ---------------->
         ...
         <!--------- Cours intensifs ------------------>
                    <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active text-nowrap" data-bs-toggle="dropdown">Cours Intensifs</a>
                            <div class="dropdown-menu " style="max-width: max-content;">
                      ...
                      <div class="accordion-item">
                          ...
                          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                              <div class="card-body">
                                  <p class="montexterecuperer" >
                                    <?php 
                                       $longTextM = $row['module']; 
                                       $longTextM = nl2br($longTextM);
                                     echo $longTextM;
                                    ?>                                                              
                                    </p>
                              </div>
                ...
                <div class="mt-4">
                  <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3 ">
                        <a href="cours_intensifs.php?id=<?php echo $row['id']; ?> "><?php echo $row['libelle']; ?> </a>
                      </div>
                  </div>
                </div>
                <?php } ?>
...
<!-- ========================================================================================================================================= -->
            ...
            <!-- quatrieme ligne -->
            <div class="col mb-3">
              <label for="formation" >Cours intensifs </label>
            <input 
            type="text" 
            readonly class="form-control" 
            name="certificat" 
            id="formation" 
            value="<?php echo $row['hpa_name']; ?>">
           </div> <br>
...
<!-- Grid column -->
  ...
  <!-- Footer -->
    ...
    function sendToWhatsapp() {
        ...
        var textMessage = "Echangez avec Brouh OSSEY...🙏\n\n*🎓 NOUVELLE DEMANDE DE PRÉ-INSCRIPTION (Cours Intensifs)*\n";
        textMessage += "--------------------------------------\n";
        ...
        textMessage += "📘 *Cours intensif visé :* " + formation + "\n";
