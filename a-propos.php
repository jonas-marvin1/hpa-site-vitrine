...
<head>
    ...
    <title>A Propos - High Performance Academy</title>
</head>
<body>
...
<section id="apropos" class="apropos-section">
    <div class="apropos">
        <div class="apropos-right">
            <img src="img/apropos.png" alt="Image A Propos De Nous">
        </div>

        <div class="apropos-left">
                <div class="titre"> <span>A</span> Propos De Nous</div>
            <p>High performance Academy (HPA) est un Cabinet de formation, d'études et de conseils créé en 2022 par des experts, ingénieurs en Stratégie de développement, marketing et finances ayant fait leur preuve au niveau national et international.</p>
            <p>Il est enregistré au RCCM d'Abidjan sous le Numéro CI-ABJ-03-2022-B12-05183.</p>
            ...
            <p>Nous concevons et implémentons des formations, séminaires et conférences de qualité pour les porteurs de projets, les entrepreneurs, les dirigeants, les étudiants et les cadres des structures privées et publiques Africaines.</p>
    ...
    <div class="commentaire">
        <br>
        <strong>Notre vision</strong>, être le Leader de la Formation en Afrique et pour se fait, nous nous donnons comme  <strong>mission</strong> de rendre les cadres Africains compétents & performants pour les structures publiques et privées.
      <br>  
      <strong>Nos valeurs</strong> sont les éléments qui guident nos relations en tant qu’équipe et aussi nos relations avec nos clients et fournisseurs.
        <ul>
            <li><strong>Notre engagement vis-à-vis du client :</strong> Le client est notre raison d’être et sa satisfaction demeure notre leitmotiv. Au quotidien, toute notre équipe garde à l’esprit, que la satisfaction du client garantit aussi notre satisfaction et nous restons donc à son écoute, disponible et réactive.</li>
            <li><strong>La confiance :</strong> Nous bâtissons une relation basée sur la confiance. La confiance entre collaborateurs et la confiance avec nos clients et fournisseurs. Nous croyons que le respect de la parole donnée, la loyauté favorise la création d’un climat de confiance. Nous croyons, demeurons attentif au potentiel de chaque individu et encourageons l’émergence de nouveaux talents.</li>
            <li><strong>La rigueur :</strong> La rigueur est la valeur qui régit nos décisions. Chaque projet qui nous est confié fait l’objet d’une attention de tous les instants, même dans les gestes les plus anodins. Nous pensons que la rigueur constitue le gage de notre travail de qualité.</li>
        </ul>
    </div>
      ...
      <div class="row g-4 justify-content-center">
          <div class="col-lg-4 col-sm-6">
              <div class="service card-effect bounceInUp">
                  ...
                  <h5 class="mt-4 mb-2">Localisation</h5>
                  <p style="font-size: 15px; color:var(--red)">Cocody, Angré 8ème tranche Voie du Lycée</p>
              </div>
          </div>
          <div class="col-lg-4 col-sm-6">
              <div class="service card-effect">
                  ...
                  <h5 class="mt-4 mb-2">Mail</h5>
                  <p style="font-size: 15px; color:var(--red)"> infos@hpacademya.com </p>
              </div>
          </div>
          <div class="col-lg-4 col-sm-6">
              <div class="service card-effect">
                  ...
                  <p style="font-size: 15px; color:var(--red)"> (+225) 07 08 02 02 44 </p>
              </div>
          </div>
      </div>
  </div>
...
<section class="bg-light" id="reviews" style="padding-top: 20px;">
  ...
  <div class="owl-theme owl-carousel reviews-slider container">
      <div class="review">
          ...
          <h3>J’ai apprécié ma formation en Anglais chez HPA. Elle m’a permis de réaliser des progrès sur mon listening et sur mon speaking.
               J’ai d’ailleurs pu mesurer les résultats de cette méthode lors d’un voyage au Nigéria. 
               La méthode pédagogique de HPA est vraiment excellente et est très axée sur le développement de l'écoute et du parler. 
               Aussi il y a un excellent service (du café & du thé à volonté) pour nous faire sentir à l'aise durant la formation</h3>
          <div class="stars">
      ...
      <div class="review">
          ...
          <h3>
              Je suis très satisfaite de ma formation en excel chez HPA. J’ai pris plaisir à assister aux cours. J’ai senti que je progressais. 
              Le principe de HPA est super : 
              des cas pratiques administrés par des formateurs très compétents.
               Cette formation me permet aujourd'hui d'être performant et productif dans mon travail.</h3>
          <div class="stars">
              <i class='bx bxs-star'></i>
              <i class='bx bxs-star'></i>
              <i class='bx bxs-star'></i>
      ...
      <div class="review">
          ...
          <h3>Je recherchais une structure fiable pour ma formation en Infographie et je suis tombé sur l'annonce de HPA. J'ai postulé et participé 
              à la fomation et aujourd'hui je peux dire que Photoshop, Ilustrator et autres n'ont point de secret pour moi. Informaticien à la base, 
              je viens d'ajouter l'infographie à mon background. 
              Grâce à HPA, je suis complet car je developpe mais je fais des affiches, des logos et je monte des vidéos. Merci HPA !</h3>
          <div class="stars">
              <i class='bx bxs-star'></i>
              <i class='bx bxs-star'></i>
              <i class='bx bxs-star'></i>
